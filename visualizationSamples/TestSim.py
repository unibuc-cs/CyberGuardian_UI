...
# showResourceUtilizationComparison_v2('../RAGSupport/dataForRAG/SmartHome_DDoSSnapshot_Data/good_RESOURCES_OCCUPANCY_HACKED_False.csv',
#                                   '../RAGSupport/dataForRAG/SmartHome_DDoSSnapshot_Data/good_RESOURCES_OCCUPANCY_HACKED_True.csv')


showLastNGetQueriesFromTopM_demandingIPs(N=10, M=3)#, path="../RAGSupport/dataForRAG/Hospital_DDoSSnapshot_Data/DATASET_LOGS_HACKED_True.csv")
